...
def page_manager_input():
    ...
    st.caption("핏투데이 시스템에서 추출한 .xlsx 파일을 올려주세요.")
    st.caption("필요한 시트: **핏투데이케어**, **스탓교육 월별 집계**")
    ...
    uploaded = st.file_uploader("", type=["xlsx"], key="mgr_upload", label_visibility="collapsed")
